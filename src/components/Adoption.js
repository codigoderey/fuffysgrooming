    ...
    return (
        <section className='adoption-area'>
                ...
                <div className='row align-items-center align-items-xl-end justify-content-center'>
                    <div className='col-xl-7 col-lg-6 col-md-10 order-0 order-lg-2'>
                        <div className='adoption-img'>
                            <img
                                src='img/images/adoption_img.jpg'
                                alt=''
                            />
                        </div>
                    </div>
                    <div className='col-xl-5 col-lg-6'>
                        <div className='adoption-content'>
                            <h2 className='title'>
                                El lugar <span>perfecto</span> para la mascota
                                perfecta
                            </h2>
                            <p>
                                Las facilidades de Fuffy’s Grooming Spot en
                                Barranquitas, proveen un ambiente relajado y de
                                esparcimiento emocional tanto para el personal
                                empleado como para nuestros amados caninos y
                                visitantes.
                            </p>
                            <p>
                                Nuestras facilidades cuentan con espacios para
                                ejecutar tanto el cuidado físico como emocional
            ...
            <div className='adoption-shape'>
                <img
                    src='img/images/adoption_shape.png'
                    alt=''
                />
            </div>
        </section>
