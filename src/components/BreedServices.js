				...
				<div className="row justify-content-center">
					<div className="col-xl-7 col-lg-9">
						<div className="section-title text-center mb-65">
							...
							<h5 className="sub-title">Servimos cualquier raza</h5>
							<h2 className="title">Amamos todos los perros</h2>
							<p>
								En Dogger, amamos a todos los perros, sin importar su raza,
								tamaño o edad. Nuestro equipo de cuidadores de perros está
								capacitado para cuidar a todos los perros, desde los más
								pequeños hasta los más grandes, y desde los más jóvenes hasta
								los más viejos. Siempre nos aseguramos de que su perro esté
								feliz y cómodo en nuestro hogar, y nos aseguramos de que su
								perro reciba el cuidado y la atención que se merece.
							</p>
						</div>
					</div>
				</div>
				<div className="row justify-content-center">
					...
					<div className="col-lg-4 col-md-6">
						<div
							...
							<h3 className="title">Comunícate para citas e información</h3>
							<p>
								Para obtener más información sobre nuestros servicios, o para
								una cita, llámenos al 787-394-9231.
							</p>
							<a href="tel:7873949231" className="btn">
								Llama <img src="img/icon/w_pawprint.png" alt="" />
							</a>
						</div>
					</div>
				</div>
